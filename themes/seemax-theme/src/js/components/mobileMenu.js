...
const menuOpen = () => {
	...
	tl.to(ham1, {duration:uniTime, rotation:-315,x:6 ,y:4, width:10, transformOrigin:"50% 50%", ease: uniEase}, "menuOpen");
	tl.to(ham2, {duration:uniTime, x:-4, width:18}, "menuOpen");
	tl.to(ham3, {duration:uniTime, rotation:315, x:6, y:-4, width:10, transformOrigin:"50% 50%", ease: uniEase}, "menuOpen");
