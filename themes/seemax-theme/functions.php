...
function theme_header_scripts() {
  if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
    ...
    wp_enqueue_script('ScrollTo', get_template_directory_uri() . '/js/ScrollToPlugin.min.js', array(), '1.0', true);
...
function theme_style() {
  wp_enqueue_style( 'google-fonts', "https://fonts.googleapis.com/css2?family=Ranchers&display=swap", false );
  wp_enqueue_style('font-awesome', get_template_directory_uri() . '/css/font-awesome.all.min.css', array(), '5.5', 'all');
  // wp_enqueue_style('seemax-fonts', get_template_directory_uri() . '/fonts/fonts.css', array(), '1.0', 'all');
...
function non_home_theme_nav() {
  wp_nav_menu(
    array(
      'theme_location'  => 'non-home-menu',
      'menu'            => '',
      'container'       => 'div',
      'container_class' => 'menu-{menu slug}-container',
      'container_id'    => '',
...
function register_html5_menu() {
  register_nav_menus(array( // Using array to specify more menus if needed
    'header-menu' => __('Home Header Menu', 'theme'), // Main Navigation
    'footer-menu' => __('Footer Menu', 'theme'), // Footer Navigation
    'non-home-menu' => __('Non-Home Header Menu', 'theme'), // Main Navigation
    'legal-menu' => __('Legal Footer Menu', 'theme') // Main Navigation
  ));
}
...
function seemax_blocks_create_post_type() {
  ...
  register_post_type('strain',
    array(
      'labels' => array(
      'name' => __('Strains'),
      'singular_name' => __('Strain')
    ),
    'public' => true,
...
function register_acf_block_types() {
  ...
  acf_register_block_type(array(
    'name'              => 'contact-subscribe-section',
    'title'             => __('Contact + Subscribe'),
    'description'       => __('Add a Contact and Subscribe section'),
    'category'          => 'layout',
    'icon'              => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12,0H0v24h12h12V0H12z M19.2,2L12,9.2L4.8,2H19.2z M22,22H1.9V2H2l10,10L22,2V22z"/></svg>',
    'keywords'          => array( 'contact', 'subscribe' ),
    'mode'               => 'preview',
    'align'             => 'full',
    'render_template'   => get_template_directory() . '/blocks/layout/contact-subscribe-section/contact-subscribe-section.php',
    'enqueue_style'     => get_template_directory_uri() . '/blocks/layout/contact-subscribe-section/contact-subscribe-section.css',
    'enqueue_script'    => get_template_directory_uri() . '/blocks/dist/js/contact-subscribe-section.js',
    'enqueue_assets' => function(){
      add_editor_style('/blocks/layout/contact-subscribe-section/contact-subscribe-section.css');
    },
  ));
  ...
  acf_register_block_type(array(
    'name'              => 'strains-section',
    'title'             => __('Strains'),
    'description'       => __('Add a strain or set of strains to the page'),
    'category'          => 'layout',
    'icon'              => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" ><path d="M12,0H0v14h24V0H12z M22,12H1.9V2H2h20V12z M8.5,7.8H3V5.9h5.4V7.8z M15,7.8H9.5V5.9H15V7.8z M21.4,7.8H16V5.9h5.4V7.8z"/></svg>',
    'keywords'          => array( 'strains', 'strain'),
    'mode'               => 'preview',
    'align'             => 'full',
    'render_template'   => get_template_directory() . '/blocks/layout/strains-section/strains-section.php',
    'enqueue_style'     => get_template_directory_uri() . '/blocks/layout/strains-section/strains-section.css',
    'enqueue_script'    => get_template_directory_uri() . '/blocks/dist/js/strains-section.js',
    'enqueue_assets' => function(){
      add_editor_style('/blocks/layout/strains-section/strains-section.css');
    },
  ));
}
...
// Wrap Core BLocks in class content
add_filter( 'render_block', 'wrap_table_block', 10, 2 );
function wrap_table_block( $block_content, $block ) {
  if ( 'core/paragraph' === $block['blockName'] ) {
    $block_content = '<div class="paragraph-block"><div class="content">' . $block_content . '</div></div>';
  }
  if ( 'core/heading' === $block['blockName'] ) {
    $block_content = '<div class="heading-block"><div class="content">' . $block_content . '</div></div>';
  }
  if ( 'core/list' === $block['blockName'] ) {
    $block_content = '<div class="list-block"><div class="content">' . $block_content . '</div></div>';
  }
